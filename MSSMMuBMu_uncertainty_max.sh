...
delta=$(echo "$slha_input" | ./scan_scale_FlexibleSUSY.sh models/MSSMMuBMu/run_MSSMMuBMu.x - "${scale_block}[${scale_entry}]" "${output_block}[${output_entry}]" "$mean_scale" 2 10 --max)
