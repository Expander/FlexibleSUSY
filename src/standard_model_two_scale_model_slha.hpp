...
/**
 * @file standard_model_two_scale_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */


#ifndef STANDARD_MODEL_TWO_SCALE_SLHA_H
#define STANDARD_MODEL_TWO_SCALE_SLHA_H
...
/**
 * @class Standard_model_slha<Two_scale>
 * @brief model class wrapper in SLHA convention
 */

template<>
class Standard_model_slha<Two_scale> : public StandardModel<Two_scale> {
public:
   Standard_model_slha();
   explicit Standard_model_slha(const StandardModel<Two_scale>&);
   virtual ~Standard_model_slha();
   ...
   const Standard_model_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   Standard_model_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   Standard_model_physical physical_slha; ///< contains the pole masses and mixings in slha convention
