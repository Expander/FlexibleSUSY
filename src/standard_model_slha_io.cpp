...
#include "standard_model_slha_io.hpp"
#include "logger.hpp"
...
char const * const Standard_model_slha_io::drbar_blocks[NUMBER_OF_DRBAR_BLOCKS] =
   { "gauge", "Yu", "Yd", "Ye", "SM", "HMIX" }
;

Standard_model_slha_io::Standard_model_slha_io()
   : slha_io()
{
}

void Standard_model_slha_io::clear()
{
   slha_io.clear();
}
 ...
 */
void Standard_model_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void Standard_model_slha_io::set_spinfo(const Problems<standard_model_info::NUMBER_OF_PARTICLES>& problems)
{
   ...
   spinfo << FORMAT_SPINFO(5, standard_model_info::model_name)
 ...
 */
void Standard_model_slha_io::set_mass(const Standard_model_physical& physical,
 ...
 */
void Standard_model_slha_io::set_mixing_matrices(const Standard_model_physical& physical,
...
void Standard_model_slha_io::set_ckm(
...
void Standard_model_slha_io::set_pmns(
 ...
 */
void Standard_model_slha_io::write_to_file(const std::string& file_name)
{
 ...
 */
double Standard_model_slha_io::get_parameter_output_scale() const
{
 ...
 * @param file_name file name
 */
void Standard_model_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void Standard_model_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void Standard_model_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void Standard_model_slha_io::fill_drbar_parameters(Standard_model& model) const
{
 ...
 */
void Standard_model_slha_io::fill(Standard_model& model) const
{
   fill_drbar_parameters(model);

   Standard_model_physical physical_hk;
 ...
 */
void Standard_model_slha_io::fill(flexiblesusy::Spectrum_generator_settings& settings) const
{
 ...
 */
void Standard_model_slha_io::fill_physical(Standard_model_physical& physical) const
{
   {
 ...
 */
double Standard_model_slha_io::read_scale() const
{
   double scale = 0.;
