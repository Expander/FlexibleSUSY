...
static double f6_1_1(double r1, double r2) noexcept
{
   ...
   return
      + (490 + d2*(280 + d2*(-28 + d2*(-7 + 9*d2))))/490.
      + d1*(280 + d2*(-28 + d2*(-7 + (9 - 6*d2)*d2)))/490.
      + d12*(-84 + d2*(-21 + d2*(27 + d2*(-18 + 10*d2))))/1470.
      + d13*(-21 + d2*(27 + d2*(-18 + (10 - 5*d2)*d2)))/1470.
      + d14*(297 + d2*(-198 + d2*(110 + d2*(-55 + 25*d2))))/16170.;
}
