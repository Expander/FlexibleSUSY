...
std::complex<long double> dilog(const std::complex<long double>& z) noexcept
{
   ...
   const long double bf[N] = {
      ...
      - 5.581785874325009336e-21l, 1.309150755418321286e-22l,
      - 3.087419802426740293e-24l, 7.315975652702203420e-26l,
      - 1.740845657234000741e-27l, 4.157635644613899720e-29l,
      - 9.962148488284622103e-31l, 2.394034424896165301e-32l
   };
