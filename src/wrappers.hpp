...
#define ZEROTENSOR3(d1,d2,d3)        Eigen::Tensor<double,3>::Zero()
#define ZEROTENSOR4(d1,d2,d3,d4)     Eigen::Tensor<double,4>::Zero()
...
#define ZEROTENSOR3COMPLEX(d1,d2,d3)  Eigen::Tensor<std::complex<double>,3>::Zero()
#define ZEROTENSOR4COMPLEX(d1,d2,d3,d4) Eigen::Tensor<std::complex<double>,4>::Zero()
