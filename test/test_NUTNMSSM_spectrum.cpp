...
BOOST_AUTO_TEST_CASE( test_NUTNMSSM_spectrum )
{
   ...
   BOOST_CHECK_CLOSE_FRACTION(Mhh_1l(1), mh0_1l(1), 0.000081);
   ...
   const softsusy::QedQcd& oneset)
{
   ...
   BOOST_CHECK_CLOSE_FRACTION(fs.get_g3(), ss.displayGaugeCoupling(3), 5.0e-07);
   ...
   BOOST_CHECK_CLOSE_FRACTION(fs.get_mHd2(), ss.displayMh1Squared(), 1.62e-2);
   ...
   BOOST_CHECK_CLOSE_FRACTION(MHpm(2), mHpm, 0.00072);

   BOOST_CHECK_CLOSE_FRACTION(MAh(1), MzRun, 1.0e-10);
   BOOST_CHECK_CLOSE_FRACTION(MAh(2), mA(1), 0.0002);
   BOOST_CHECK_CLOSE_FRACTION(MAh(3), mA(2), 0.00072);

   BOOST_CHECK_CLOSE_FRACTION(Mhh(1), mh(1), 0.00015);
   BOOST_CHECK_CLOSE_FRACTION(Mhh(2), mh(2), 0.00072);
   ...
   BOOST_CHECK_CLOSE_FRACTION(MHpm_1l(2), mHpm_1l, 0.00073);

   BOOST_CHECK_CLOSE_FRACTION(MAh_1l(2), mA_1l(1), 0.0004);
   BOOST_CHECK_CLOSE_FRACTION(MAh_1l(3), mA_1l(2), 0.00073);

   BOOST_CHECK_CLOSE_FRACTION(Mhh_1l(1), mh_1l(1), 0.0001);
   BOOST_CHECK_CLOSE_FRACTION(Mhh_1l(2), mh_1l(2), 0.00074);
   ...
   BOOST_CHECK_CLOSE_FRACTION(Mhh_2l(1), mh_2l(1), 8.3e-05);
   BOOST_CHECK_CLOSE_FRACTION(Mhh_2l(2), mh_2l(2), 0.00011);
   BOOST_CHECK_CLOSE_FRACTION(Mhh_2l(3), mh_2l(3), 0.0005);
