...
#ifndef TEST_NMSSMCPV_H
#define TEST_NMSSMCPV_H
...
void setup_NMSSMCPV(NMSSMCPV<Two_scale>& m, const NMSSMCPV_input_parameters& input)
{
   ...
   const double vS = input.LambdaTimesvSInput / lambda;
