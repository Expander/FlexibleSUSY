...
#define BOOST_TEST_MODULE test_munuSSMSemiAnalytic_semi_analytic_solutions
...
BOOST_AUTO_TEST_CASE( test_munuSSMSemiAnalytic_coefficients )
{
   ...
   munuSSMSemiAnalytic_mass_eigenstates coeffs_model(model);
   ...
   TEST_CLOSE_REL(model.get_mlHd2(), coeffs_model.get_mlHd2(), 1.0e-2);
