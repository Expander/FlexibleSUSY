...
#define BOOST_TEST_MODULE test_NMSSM_slha_output
                              ...
                              const std::vector<int>& exclude)
{
   ...
   for (SLHAea::Block::const_iterator line = coll1.at(name).begin(),
      ...
      BOOST_CHECK_CLOSE_FRACTION(value, value2, 8.5e-3);
   }
}
...
{
   const std::string input_file("test/test_NMSSM_slha_output.in.spc");
   const std::string output_file("test/test_NMSSM_slha_output.out.spc");
