...
RunPoint[QEW_] :=
    Module[{handle, spectrum, observables, problems},
           ...
           problems    = FSSMGetProblems[handle];
           FSSMCloseHandle[handle];
           {spectrum, observables, problems}
    ];

(* valid point w/o problems *)
{spectrum, observables, problems} = RunPoint[173];
