...
BOOST_AUTO_TEST_CASE(test_numeric)
{
   ...
   BOOST_CHECK_CLOSE_FRACTION(std::real(Bxz  ),   2.1828815497944780, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Byu  ),   1.3097038687359490, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Svyz ), -31.2543090480954149, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Suxv ), -31.5461792884989656, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Sxuv ), -31.5461792884989656, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Suvx ), -31.5461792884989656, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Svux ), -31.5461792884989656, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Sxvu ), -31.5461792884989656, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Svxu ), -31.5461792884989656, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Tuxv ),   0.8763732955387802, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Tyzv ),   0.5123629327539176, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Txuv ),   0.4662594413917679, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Tzyv ),   0.6656794217040922, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Tvxu ),   1.0054064846763813, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Tvyz ),   0.9432272340849203, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Uuyxv),   0.9863678693113318, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Uzxyv),   1.0286440457448356, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Uzxvy),   1.0286440457448356, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Uxzuv),   0.2725852029409196, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Uyuzv),   0.2952750228795177, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Vzxyv),   0.5589744541751330, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Vuyxv),   0.1762338999120509, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Vxzuv),   0.1985617199983827, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(Vyuzv),   0.0588643927348281, eps);
   BOOST_CHECK_CLOSE_FRACTION(std::real(M    ),   0.4877200674519486, eps);
}
