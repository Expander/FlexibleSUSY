...
delta=$(echo "$slha_input" | ./scan_scale_FlexibleSUSY.sh models/MRSSMMSUSY/run_MRSSMMSUSY.x - "${scale_block}[${scale_entry}]" "${output_block}[${output_entry}]" "$mean_scale" 2 10 --min)
