...
// File generated at Thu 1 May 2014 16:04:07

#include "phdUMSSM_input_parameters.hpp"
#include "phdUMSSM_spectrum_generator.hpp"
...
int main(int argc, const char* argv[])
{
   ...
   phdUMSSM_input_parameters input;
   QedQcd oneset;
   oneset.toMz();

   phdUMSSM_spectrum_generator<algorithm_type> spectrum_generator;
   ...
   for (auto tanBeta : range_TanBeta) {
      for (auto m0 : range_m0) {
         ...
         const phdUMSSM<algorithm_type>& model = spectrum_generator.get_model();
         const phdUMSSM_physical& pole_masses = model.get_physical();
         const Problems<phdUMSSM_info::NUMBER_OF_PARTICLES>& problems
