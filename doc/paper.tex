...
\begin{enumerate}
\item Create new directory \code{mkdir NMSSM}
\item Move into this new directory \code{cd NMSSM}
\item copy the MSSM model file in \code{cp /path/to/SARAH/Models/MSSM/MSSM.m  NMSSM.m}
\item Edit NMSSM.m as follows
\begin{enumerate}
