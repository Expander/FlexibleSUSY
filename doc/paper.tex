...
lightest supersymmetric particle (LSP).  To let this function be
...
\begin{table}[tbh]
  ...
  \begin{tabular}{llll}
    ...
    \midrule
    FlexibleSUSY-NoFV 0.5.4 & $0.086\unit{s}$    & $0.079\unit{s}$   & $0.060\unit{s}$\\
    SPheno 3.2.4            & $0.119\unit{s}$    & $0.114\unit{s}$   & $0.101\unit{s}$\\
    Softsusy 3.4.0          & $0.175\unit{s}$    & $0.171\unit{s}$   & $0.147\unit{s}$\\
    \midrule
    FlexibleSUSY-FV 0.5.4   & $0.150\unit{s}$    & $0.113\unit{s}$   & $0.074\unit{s}$\\
