...
MRSSM etc., which can be generated immediately without any editing.
In particular the CMSSM and NMSSM spectrum generators constitute
alternatives to the existing ones Softsusy, SPheno and NMSPEC.  We
have shown that the generated source code can be influenced at two
different levels: The \mathematica level where the user provides a
...
common and most extraordinary models.
