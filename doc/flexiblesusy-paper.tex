...
where both cores were enabled.  In the third column an Intel Xeon
(L5640, $2.27\unit{GHz}$) was used, which has two CPUs with $6$ cores
each.
%
\begin{table}[tbh]
  \centering
  \begin{tabular}{llll}
    \toprule
                            ...
                            & (P8600, $1$ core)  & (P8600, $2$ cores)& (L5640, $2\times 6$ cores)\\
    \midrule
