...
\begin{table}[tbh]
  ...
  \begin{tabular}{llll}
    ...
    & $128\unit{GeV}$ ($2.532\unit{ms}$)
    & $126\unit{GeV}$ ($9.787\unit{ms}$) \\
    $m_{\tilde{g}}$
    & $10167\unit{GeV}$ ($0.10\unit{ms}$)
    & $10167\unit{GeV}$ ($0.10\unit{ms}$)
    & $10251\unit{GeV}$ ($0.408\unit{ms}$) \\
    $m_{\tilde{u}_1}$
    & $8702\unit{GeV}$ ($2.5\unit{ms}$)
    & $8714\unit{GeV}$ ($15.695\unit{ms}$)
    & $8734\unit{GeV}$ ($60.874\unit{ms}$) \\
    \bottomrule
  \end{tabular}
  \caption{Comparison of pole masses with different used calculation
    precisions for the CMSSM with $m_0=8\unit{TeV}$, $M_{1/2}=A_0=5\unit{TeV}$,
