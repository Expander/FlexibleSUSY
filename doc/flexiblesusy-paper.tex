...
switches to \code{True} in any MSSM-\footnote{In \fs a model is
  ...
  MSSM-like coupling to $t$, $b$ and $\tau$.} and
NMSSM-like\footnote{In \fs a model is NMSSM-like if (i) its
  superpotential is approximately given by the NMSSM one, (ii) it
