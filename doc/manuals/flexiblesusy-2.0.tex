...
\begin{figure}[tbh]
  \centering
  \subfloat[]{
  \quad\includegraphics{doc/manuals/Feynman/deltaVBWave}\quad
  \label{fig:delta_VB_wave_diagrams}
  }
  \subfloat[]{
  \qquad\includegraphics{doc/manuals/Feynman/deltaVBVertex1}\quad
  \includegraphics{doc/manuals/Feynman/deltaVBVertex2}\qquad
  \label{fig:delta_VB_vertex_diagrams}
  }
  \subfloat[]{
  \quad\includegraphics{doc/manuals/Feynman/deltaVBBox1}\quad
