...
QCD corrections can be taken into account.  See the documentation of
the `SLHA input parameters`_ for a description of the individual flags
to enable/disable 2- and 3-loop threshold corrections in FlexibleSUSY.
