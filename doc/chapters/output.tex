...
The expressios for the SM-Yukawa coupling matrices extracted from the
...
\begin{align}
  ...
  y_e^{\text{\DRbar}}(M_Z) &= \frac{\sqrt{2} m_{e}^T}{v_e}.
\end{align}
%
...
\end{align}
%
where $m_{\tau,\text{SM}}^{\text{\MSbar}}(M_Z)$ is user input.
