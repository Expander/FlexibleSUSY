...
// File generated at Sun 16 Nov 2014 00:27:09
...
public:
   ...
   template <class T> void fill(MSSMNoFVatMGUT<T>&) const;
   ...
   template <class T> void set_extra(const MSSMNoFVatMGUT<T>&);
...
private:
   ...
   template <class T> void set_model_parameters(const MSSMNoFVatMGUT<T>&);
   double read_scale() const;
   template <class T> void fill_drbar_parameters(MSSMNoFVatMGUT<T>&) const;
   template <class T> void fill_physical(MSSMNoFVatMGUT<T>&) const;
};
 ...
 */
template <class T>
void MSSMNoFVatMGUT_slha_io::fill(MSSMNoFVatMGUT<T>& model) const
{
 ...
 */
template <class T>
void MSSMNoFVatMGUT_slha_io::fill_drbar_parameters(MSSMNoFVatMGUT<T>& model) const
{
 ...
 */
template <class T>
void MSSMNoFVatMGUT_slha_io::fill_physical(MSSMNoFVatMGUT<T>& model) const
{
   {
      DEFINE_PARAMETER(ZH);
 ...
 */
template <class T>
void MSSMNoFVatMGUT_slha_io::set_model_parameters(const MSSMNoFVatMGUT<T>& model)
{
   {
 ...
 */
template <class T>
void MSSMNoFVatMGUT_slha_io::set_extra(const MSSMNoFVatMGUT<T>& model)
{
   MSSMNoFVatMGUT_physical physical(model.get_physical());
