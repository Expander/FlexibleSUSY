...
// File generated at Sun 16 Nov 2014 00:31:14
...
int main(int argc, char* argv[])
{
   ...
   for (std::vector<double>::const_iterator it = range.begin(),
      ...
      const MSSMNoFVatMGUT<algorithm_type>& model = spectrum_generator.get_model();
      const MSSMNoFVatMGUT_physical& pole_masses = model.get_physical();
