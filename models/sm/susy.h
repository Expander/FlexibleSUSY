...
inline const MssmSusy & MssmSusy::displaySusy() const
{
   return *this;
}

inline void MssmSusy::setGaugeCoupling(int i, double f)
{
   g(i) = f;
}
...
inline double MssmSusy::displayHvev() const
{
   return hVev;
}

inline void MssmSusy::setHvev(double h)
{
   hVev = h;
}
inline void MssmSusy::setSusyMu(double f)
{
   smu = f;
}
inline void MssmSusy::setTanb(double f)
{
   tanb = f;
}
inline DoubleVector MssmSusy::displayGauge() const
{
   return g;
}
...
inline double MssmSusy::displaySusyMu() const
{
   return smu;
}
