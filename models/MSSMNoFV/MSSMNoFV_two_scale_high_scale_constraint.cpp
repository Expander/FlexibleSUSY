...
// File generated at Sun 16 Nov 2014 00:02:49
...
MSSMNoFV_high_scale_constraint<Two_scale>::MSSMNoFV_high_scale_constraint(const MSSMNoFV_input_parameters& inputPars_)
   : Constraint<Two_scale>()
   , fixed_scale(0.)
   , model(0)
...
{
   assert(model && "Error: MSSMNoFV_high_scale_constraint:"
