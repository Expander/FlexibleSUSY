...
// File generated at Sun 16 Nov 2014 00:02:46
...
public:
   ...
   template <class T> void fill(MSSMNoFV<T>&) const;
   ...
   template <class T> void set_extra(const MSSMNoFV<T>&);
...
private:
   ...
   template <class T> void set_model_parameters(const MSSMNoFV<T>&);
   double read_scale() const;
   template <class T> void fill_drbar_parameters(MSSMNoFV<T>&) const;
   template <class T> void fill_physical(MSSMNoFV<T>&) const;
};
 ...
 */
template <class T>
void MSSMNoFV_slha_io::fill(MSSMNoFV<T>& model) const
{
 ...
 */
template <class T>
void MSSMNoFV_slha_io::fill_drbar_parameters(MSSMNoFV<T>& model) const
{
 ...
 */
template <class T>
void MSSMNoFV_slha_io::fill_physical(MSSMNoFV<T>& model) const
{
   {
      DEFINE_PARAMETER(ZH);
 ...
 */
template <class T>
void MSSMNoFV_slha_io::set_model_parameters(const MSSMNoFV<T>& model)
{
   {
 ...
 */
template <class T>
void MSSMNoFV_slha_io::set_extra(const MSSMNoFV<T>& model)
{
   MSSMNoFV_physical physical(model.get_physical());
