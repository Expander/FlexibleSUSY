...
Model`Name = "MDM";
Model`NameLaTechi ="Standard Model";
...
FermionFields[[6]] = {r, 1,
{{{{gL, cL/Sqrt[4]}, {cL/Sqrt[4], nL/Sqrt[6]}}, {{cL/Sqrt[4], nL/Sqrt[6]}, {nL/Sqrt[6],
    conj[cR]/Sqrt[4]}}}, {{{cL/Sqrt[4], nL/Sqrt[6]}, {nL/Sqrt[6], conj[cR]/Sqrt[4]}}, {{nL/Sqrt[6], conj[cR]/Sqrt[4]}, {conj[cR]/Sqrt[4],
    conj[gR]}}}}
,0, 5 , 1};
...
{{Yr r.r, {Overwrite->True, AddHC->False}}};*)
...
DEFINITION[EWSB][MatterSector]=   
    {{{{dL}, {conj[dR]}}, {{DL,Vd}, {DR,Ud}}},
     ...
     {{{cL}, {conj[cR]}}, {{CL,Vc}, {CR,Uc}}},
     {{{gL}, {conj[gR]}}, {{GL,Vg}, {GR,Ug}}},
     {{nL},{NL,Un}}
     };
