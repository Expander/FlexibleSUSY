...
Model`Name = "HTHDMII";
Model`NameLaTeX ="Two Higgs Doublet Model II w/ Higgsinos";
...
FermionFields[[6]] = {Hd, 1, {FHd0, FHdm}, -1/2, 2, 1, RpM};
FermionFields[[7]] = {Hu, 1, {FHup, FHu0},  1/2, 2, 1, RpM};
...
(* @todo add Higgsino terms *)
LagHiggsino = - \[Mu] Hu.Hd;
