	      ...
	      vertexRules = Get[vertexRuleFileName]];
           ...
           WriteModelClass[massMatrices, ewsbEquations,
                           ...
                           {{FileNameJoin[{Global`$flexiblesusyTemplateDir, "model.hpp.in"}],
                            ...
                            {FileNameJoin[{Global`$flexiblesusyTemplateDir, "imodel.hpp.in"}],
                             FileNameJoin[{Global`$flexiblesusyOutputDir, FlexibleSUSY`FSModelName <> "_imodel.hpp"}]},
                            {FileNameJoin[{Global`$flexiblesusyTemplateDir, "imodel.cpp.in"}],
                             FileNameJoin[{Global`$flexiblesusyOutputDir, FlexibleSUSY`FSModelName <> "_imodel.cpp"}]},
