...
WriteModelClass[massMatrices_List, tadpoleEquations_List, modelName_String,
    ...
    Module[{massGetters = "", k,
           ...
           For[k = 1, k <= Length[massMatrices], k++,
               ...
               physicalMassesInitNoLeadingComma = StringTrim[physicalMassesInit, RegularExpression["^,"]];
           ...
           masses                       = SARAH`Mass[TreeMasses`GetMassEigenstate[#]]& /@ massMatrices;
...
MakeFlexibleSUSY[OptionsPattern[]] :=
    Module[{nPointFunctions, eigenstates = OptionValue[Eigenstates],
           ...
           allParticles = SARAH`Mass[GetMassEigenstate[#]]& /@ massMatrices;
