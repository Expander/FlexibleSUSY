...
deltaRHat2LoopSM[]:=Module[{gY, alphaDRbar, xt, hmix, expr, result},
                           ...
                           xt = 3 / (8 Pi^2 Sqrt[2]) gfermi mt^2;
                           hmix = (FlexibleSUSY`ZH[0,1] / Sin[ArcTan[FlexibleSUSY`vu/FlexibleSUSY`vd]])^2;
                           expr = alphaDRbar SARAH`g3^2/(16 Pi^3 sinThetaW^2 (1 - sinThetaW^2))(2.145 mt^2/mz^2 + 0.575 Log[mt/mz] - 0.224 - 0.144 mz^2/mt^2) - xt^2 hmix RHO2[FlexibleSUSY`M[hh[0]]/mt] (1 - deltaRHat1Loop) rhohat / 3;
                           result = Parameters`CreateLocalConstRefs[expr] <> "\n";
