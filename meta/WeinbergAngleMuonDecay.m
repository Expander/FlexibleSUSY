...
extPars={sinThetaW, rhohat, gfermi, mw, mz, mt, RHO2, deltaRHat1Loop, pizztMZcorrected};
...
deltaRhoHat2LoopSM[]:=Module[{gY, alphaDRbar, xt, hmix, expr, result},
                             ...
                             expr = (alphaDRbar SARAH`strongCoupling^2/(16 Pi^3 sinThetaW^2)(-2.145 mt^2/mw^2 + 1.262 Log[mt/mz] - 2.24 - 0.85 mz^2/mt^2) + xt^2 hmix RHO2[FlexibleSUSY`M[SARAH`HiggsBoson[0]]/mt] / 3) / (1 + pizztMZcorrected / mz^2);
