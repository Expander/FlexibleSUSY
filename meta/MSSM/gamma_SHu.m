...
{(-3*g1^2)/10 - (3*g2^2)/2 + 3*trace[Adj[Yt], Yt], 
 (207*g1^4)/100 + (9*g1^2*g2^2)/10 + (15*g2^4)/4 + 
  (4*g1^2*trace[Adj[Yt], Yt])/5 + 16*g3^2*trace[Adj[Yt], Yt] - 
  3*trace[Adj[Yt], Yt, Adj[Yb], Yb] - 9*trace[Adj[Yt], Yt, Adj[Yt], Yt], 
 (1839*g1^6)/100 + (27*g1^4*g2^2)/100 + (9*g1^2*g2^4)/4 + (345*g2^6)/4 + 
  (66*g1^4*g3^2)/5 + 90*g2^4*g3^2 - (21*g1^4*trace[Adj[Yb], Yb])/10 - 
  (45*g2^4*trace[Adj[Yb], Yb])/2 - (27*g1^4*trace[Adj[Ye], Ye])/10 - 
  (15*g2^4*trace[Adj[Ye], Ye])/2 - (2123*g1^4*trace[Adj[Yt], Yt])/60 - 
  (57*g1^2*g2^2*trace[Adj[Yt], Yt])/10 - (225*g2^4*trace[Adj[Yt], Yt])/4 - 
  (124*g1^2*g3^2*trace[Adj[Yt], Yt])/3 - 132*g2^2*g3^2*trace[Adj[Yt], Yt] - 
  (160*g3^4*trace[Adj[Yt], Yt])/3 + (6*g1^2*trace[Adj[Yt], Yt, Adj[Yb], Yb])/
   5 + 18*g2^2*trace[Adj[Yt], Yt, Adj[Yb], Yb] + 
  24*g3^2*trace[Adj[Yt], Yt, Adj[Yb], Yb] + 18*trace[Adj[Yb], Yb]*
  ...
  3*trace[Adj[Yt], Yt, Adj[Yt], Yt, Adj[Yt], Yt] - (1791*g1^6*Zeta[3])/250 - 
  ...
  144*g2^2*g3^2*trace[Adj[Yt], Yt]*Zeta[3] - 16*g3^4*trace[Adj[Yt], Yt]*
   Zeta[3] + (6*g1^2*trace[Adj[Yt], Yt, Adj[Yb], Yb]*Zeta[3])/5 - 
